...
@section('content')
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.returnpurchases.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.returnpurchases.title_singular') }}
            </a>
        </div>
    </div>
    ...
    <div class="card w-100">
        <div class="card-header">
            {{ trans('cruds.returnpurchases.title_singular') }} {{ trans('global.list') }}
        </div>
                ...
                <table id="example" class="display nowrap" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th>
                                {{ trans('cruds.returnpurchases.fields.id') }}
                            </th>
                            <th>
                                {{ trans('cruds.returnpurchases.fields.code') }}
                            </th>
                            <th>
                                {{ trans('cruds.returnpurchases.fields.purchase') }}
                            </th>
                            <th>
                                {{ trans('cruds.returnpurchases.fields.reason') }}
                            </th>
                            <th>
                                {{ trans('cruds.returnpurchases.fields.date') }}
                            </th>
                            <th width="8%">
                                {{ trans('cruds.returnpurchases.fields.qty') }}
                            </th>
                            <th width="8%">
                                {{ trans('cruds.returnpurchases.fields.refundamount') }}
                            </th>
                            <th  width="20%">
                                {{ trans('cruds.returnpurchases.fields.note') }}
                            </th>
                            <th>
                                Action
                            </th>
                    ...
                    <tbody>
                        ...
                        @foreach ($return as $c)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="text-decoration-none" href="{{ route('admin.returnpurchases.edit', $c->id) }}">
                                        {{ $c->return_code }}
                                    </a>
                                </td>
                                <td>
                                ...
                                <td>
                                    {{ $c->return_reason ? substr($c->return_reason, 0, 25) . '...' : '' }}
                                </td>
                                <td>
                                    {{ $c->return_date }}
                                </td>
                                <td>
                                    ...
                                    @foreach (json_decode($c->returnqty, true) as $prod)
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.returnpurchases.show', $c->id) }}">
                                        {{ trans('global.view') }}
                                    </a>



                                    <a class="btn btn-xs btn-info" href="{{ route('admin.returnpurchases.edit', $c->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>

                                    <form action="{{ route('admin.returnpurchases.destroy', $c->id) }}" method="POST"
