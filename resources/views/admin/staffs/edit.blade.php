            ...
            <form method="POST" action="{{ route('admin.staffs.update', [$staff->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group mr-3">
                    ...
                    <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address"
                        id="address" value="{{ old('address', '') }}" required> {{ $staff->address }} </textarea>
                ...
                <div class="form-group">
                    ...
                    @endif
                    <input type="hidden" id="old_profile_picture" name="old_profile_picture"
                        value="{{ $staff->profile_image }}">
                ...
                <div class="form-group">
                    ...
                    {{-- @if ($staff->profile_image != null && file_exists(storage_path('app/staff/' . $staff->profile_image)))
                        <img src="{{ asset('storage/app/staff/' . $staff->profile_image) }}" alt="No image">
                    @endif --}}
                    @if ($staff->profile_image != null && file_exists(public_path('app/staff/' . $staff->profile_image)))
                        <img src="{{ asset('app/staff/' . $staff->profile_image) }}" alt="No image" height="100" width="140">
                    @endif
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="password"
                        minlength="8" name="password" id="password">
